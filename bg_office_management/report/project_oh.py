...
class OverheadProjectReport(models.TransientModel):
    ...
    def get_details(self):
        ...
        for project in project_ids:
            ...
            feb_over_head_distribution_sum = feb_monthly_overhead_sum * jan_weightage/100
            mar_over_head_distribution_sum = mar_monthly_overhead_sum * jan_weightage/100
            apr_over_head_distribution_sum = apr_monthly_overhead_sum * jan_weightage/100
            may_over_head_distribution_sum = may_monthly_overhead_sum * jan_weightage/100
            jun_over_head_distribution_sum = jun_monthly_overhead_sum * jan_weightage/100
            jul_over_head_distribution_sum = jul_monthly_overhead_sum * jan_weightage/100
            aug_over_head_distribution_sum = aug_monthly_overhead_sum * jan_weightage/100
            sep_over_head_distribution_sum = sep_monthly_overhead_sum * jan_weightage/100
            oct_over_head_distribution_sum = oct_monthly_overhead_sum * jan_weightage/100
            nov_over_head_distribution_sum = nov_monthly_overhead_sum * jan_weightage/100
            dec_over_head_distribution_sum = dec_monthly_overhead_sum * jan_weightage/100
            ...
            dict = {
                ...
                'jan':round(jan_over_head_distribution_sum),
                'feb':round(feb_over_head_distribution_sum),
                'mar':round(mar_over_head_distribution_sum),
                'apr':round(apr_over_head_distribution_sum),
                'may':round(may_over_head_distribution_sum),
                'jun':round(jun_over_head_distribution_sum),
                'jul':round(jul_over_head_distribution_sum),
                'aug':round(aug_over_head_distribution_sum),
                'sep':round(sep_over_head_distribution_sum),
                'oct':round(oct_over_head_distribution_sum),
                'nov':round(nov_over_head_distribution_sum),
                'dec':round(dec_over_head_distribution_sum),
